...
class _DessertPageState extends State<DessertPage> {
  ...
  void _loadInterstitialAd() {
    InterstitialAd.load(
      adUnitId: 'ca-app-pub-8363980854824352/7796378706',
      request: AdRequest(),
  ...
  void _loadBannerAd() {
    _bannerAd = BannerAd(
      adUnitId: 'ca-app-pub-8363980854824352/8303661076',
      request: AdRequest(),
  ...
  Future<void> fetchData() async {
    const singleJsonUrl = 'https://pastebin.com/raw/efs91hHs';
...
class _DetailPageState extends State<DetailPage> {
  ...
  void _loadBannerAd() {
    _bannerAd = BannerAd(
      adUnitId: 'ca-app-pub-8363980854824352/7987950399',
      request: AdRequest(),
      size: AdSize.mediumRectangle,
      listener: BannerAdListener(
        onAdLoaded: (Ad ad) {
