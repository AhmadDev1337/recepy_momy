...
class _DinnerPageState extends State<DinnerPage> {
  ...
  void _loadInterstitialAd() {
    InterstitialAd.load(
      adUnitId: 'ca-app-pub-8363980854824352/6806730669',
      request: AdRequest(),
  ...
  void _loadBannerAd() {
    _bannerAd = BannerAd(
      adUnitId: 'ca-app-pub-8363980854824352/5458005889',
      request: AdRequest(),
  ...
  Future<void> fetchData() async {
    const singleJsonUrl = 'https://pastebin.com/raw/7jwcgbZg';
...
class _DetailPageState extends State<DetailPage> {
  ...
  void _loadBannerAd() {
    _bannerAd = BannerAd(
      adUnitId: 'ca-app-pub-8363980854824352/8502955710',
      request: AdRequest(),
      size: AdSize.mediumRectangle,
      listener: BannerAdListener(
        onAdLoaded: (Ad ad) {
