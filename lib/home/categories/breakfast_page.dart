// ignore_for_file: unused_field, unnecessary_null_comparison, avoid_print, avoid_unnecessary_containers, prefer_const_constructors, prefer_const_literals_to_create_immutables, depend_on_referenced_packages, unnecessary_import, deprecated_member_use, sized_box_for_whitespace, use_super_parameters
...
class _BreakfastPageState extends State<BreakfastPage> {
  ...
  void _loadInterstitialAd() {
    InterstitialAd.load(
      adUnitId: 'ca-app-pub-8363980854824352/6196372484',
      request: AdRequest(),
  ...
  void _loadBannerAd() {
    _bannerAd = BannerAd(
      adUnitId: 'ca-app-pub-8363980854824352/4937802149',
      request: AdRequest(),
  ...
  Future<void> fetchData() async {
    const singleJsonUrl = 'https://pastebin.com/raw/4scHM1if';
...
class _DetailPageState extends State<DetailPage> {
  ...
  void _loadBannerAd() {
    _bannerAd = BannerAd(
      adUnitId: 'ca-app-pub-8363980854824352/2927195405',
      request: AdRequest(),
      size: AdSize.mediumRectangle,
      listener: BannerAdListener(
        onAdLoaded: (Ad ad) {
